...
1. Replace `<your_account>` with your Github username in the links
    - [DEMO LINK](https://KhrystynaYelyseyeva.github.io/layout_antisnake/)
    - [TEST REPORT LINK](https://KhrystynaYelyseyeva.github.io/layout_antisnake/report/html_report/)
