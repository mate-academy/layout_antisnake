# Antisnake
Replace `nazarht` with your Github username and copy the links to Pull Request description:
- [DEMO LINK](https://nazarht.github.io/layout_antisnake/)
- [TEST REPORT LINK](https://nazarht.github.io/layout_antisnake/report/html_report/)
